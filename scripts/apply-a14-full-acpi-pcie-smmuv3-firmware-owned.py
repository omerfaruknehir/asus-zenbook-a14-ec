...
'''
    ...
    if final.count('A14: leaving PCIe SMMUv3[%llx] firmware-owned at EL1') != 1:
        fail("ownership skip duplicated")
    if 'goto next_iort_node;' in final or 'next_iort_node:' in final:
        fail("obsolete goto-based ownership skip remains")
