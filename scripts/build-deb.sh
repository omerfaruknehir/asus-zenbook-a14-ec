...
Depends: dkms, kmod, systemd, build-essential
Recommends: linux-headers-generic | linux-headers-arm64
...
Description: ASUS Zenbook A14 EC and keyboard drivers (DKMS)
 ...
 hotkeys for ASUS Zenbook A14 UX3407RA/UX3407QA Snapdragon systems.
CONTROL
